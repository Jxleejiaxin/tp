 ...
 * applicants uses Applicant#isSameApplicant(Applicant) for equality to ensure that the applicant being added or updated is
 * unique in terms of identity in the UniqueApplicantList. However, the removal of an applicant uses Applicant#equals(Object)
 * to ensure that the applicant with exactly the same fields will be removed.
 *
